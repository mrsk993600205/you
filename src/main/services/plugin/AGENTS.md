...
Plugin hub orchestrating Ikun music/LuoXue plugins: lifecycle control, IPC bridge, metadata fetch delegation, sandboxing via VM context.
...
- Plugin files live under `%appData%/IkunMusic/plugins`. Host only exposes whitelisted FS + network APIs.
