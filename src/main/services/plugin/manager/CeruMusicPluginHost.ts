...
class IkunMusicPluginHost {
  ...
  private async _spawn(): Promise<void> {
    ...
    try {
      ...
      this.worker = null
      throw new PluginError('无法初始化Ikun music插件,可能是插件格式不正确. ' + err.message)
    }
  }
...
export default IkunMusicPluginHost
