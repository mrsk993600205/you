 ...
 *   new Request(IKUNMUSIC_API_RESOURCE)
 *   new SocketRequest('/lt', IKUNMUSIC_API_RESOURCE)
 *
...
/** IkunMusic 主后端(房间/分享/账户同步等都用它) */
export const IKUNMUSIC_API_RESOURCE = getResource('IkunMusic-Backend')
