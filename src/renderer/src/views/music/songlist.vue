...
const loadPlaylists = async () => {
  ...
  try {
    // disabled: cloud/sharing - getCloudSongList and cloud merge removed
    ...
    // disabled: cloud/sharing - cloud list merging removed
...
const viewPlaylist = (playlist: SongList) => {
  // disabled: cloud/sharing - isCloudOnly routing removed
...
const contextMenuItems = computed((): ContextMenuItem[] => {
  ...
  // disabled: cloud/sharing - isCloudOnly and isSynced removed

  const items: ContextMenuItem[] = []

  // disabled: cloud/sharing - Cloud Actions removed

  // Standard items for local
  items.push(
  ...
  // disabled: cloud/sharing - Sync Actions removed
    ...
    createMenuItem('export', '导出歌单', {
      onClick: async () => {
        ...
        try {
          ...
          const fileName = `IkunMusic-${safeName}.cmpl`
              ...
              <div class="playlist-name-row" @click="viewPlaylist(playlist)">
                ...
                >
                  <t-tag
                    ...
                    >我的喜欢</t-tag
                  >
                  <!-- disabled: cloud/sharing - CloudIcon tags removed -->
                </div>
              </div>
