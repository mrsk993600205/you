<template>
  ...
  >
    <div class="content">
      ...
      <p>
        开源地址：
        <a href="#" @click.prevent="openLink('https://github.com/timeshiftsauce/IkunMusic')">
          https://github.com/timeshiftsauce/IkunMusic
        </a>
      </p>
      <p>
        唯一交流QQ群：
...
const STORAGE_KEY = 'ikun_music_has_seen_first_run_notice_tips'
