...
onMounted(() => {
  ...
  window.addEventListener('ikunmusic-show-close-dialog', handler)
  unsubShowDialog = () => window.removeEventListener('ikunmusic-show-close-dialog', handler)
