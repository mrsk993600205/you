...
// import { getHeartbeatRecommendation, clearHeartbeatCache } from './heartbeat' // disabled: heartbeat
...
const updatePlayMode = () => {
  // disabled: heartbeat - removed HEARTBEAT from cycle
