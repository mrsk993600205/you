...
Vue 3 + Vite renderer powering the Ikun music UI: Pinia stores, naive-ui/tdesign dual UI kits, auto-imported components, routes for home/music/settings/download/user/welcome.
