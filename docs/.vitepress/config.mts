...
export default defineConfig({
  ...
  head: [
    ...
    [
      'meta',
      {
        name: 'keywords',
        content:
          'Ikun music,音乐播放器,音乐播放器工具,音乐播放器软件,音乐播放器下载,音乐播放器下载地址,Ikun music播放器,免费的音乐播放器,ikunmusic,时迁酱,周晨鹭,无聊的霜霜,star,洛雪音乐,洛雪'
      }
    ],
  ...
  description:
    'Ikun music 是基于 Electron 和 Vue 开发的跨平台桌面音乐播放器工具，一个跨平台的音乐播放器应用，支持基于合规插件获取公开音乐信息与播放功能。',
  markdown: {
    config(md) {
      md.use(note)
    }
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        text: 'Ikun music&插件',
        items: [
          { text: '插件类使用', link: '/guide/IkunMusicPluginHost' },
          { text: 'Ikun music插件开发文档（重点）', link: '/guide/IkunMusicPluginDev' },
          { text: 'Ikun music后端对接文档', link: '/guide/api' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/timeshiftsauce/IkunMusic' },
    ...
    editLink: {
      pattern: 'https://github.com/timeshiftsauce/IkunMusic/edit/main/docs/:path'
    },
    search: {
      provider: 'local'
    },
