...
IkunMusic 插件通知系统允许插件向用户显示各种类型的通知对话框，包括信息、警告、错误、成功和更新通知。
...
```javascript
// 基本用法
this.ikunmusic.NoticeCenter(type, data)

// 信息通知
this.ikunmusic.NoticeCenter('info', {
  title: '插件信息',
  message: '这是一条信息通知',
  content: '详细的信息内容'
})
...
// 警告通知
this.ikunmusic.NoticeCenter('warning', {
  title: '注意',
  message: '这是一条警告信息',
  content: '请检查相关设置'
})
...
// 错误通知
this.ikunmusic.NoticeCenter('error', {
  title: '错误',
  message: '操作失败',
  error: '具体的错误信息'
})
...
// 成功通知
this.ikunmusic.NoticeCenter('success', {
  title: '成功',
  message: '操作已成功完成'
})

// 更新通知（特殊）
this.ikunmusic.NoticeCenter('update', {
  title: '插件更新',
